...
* **Sørg for store interaktionsflader**, så det bliver lettere for brugeren at ramme sit mål, f.eks. at aktivere et link eller en knap. Selvom brugeren kan zoome via øjnene, er det ofte en udfordring at ramme små interaktionsflader. Som udgangspunkt bør en interaktionsflade minimum være 44 gange 44 CSS-pixels (se mere under [WCAG-succeskriterium 2.2.5 om Målstørrelse](https://www.w3.org/Translations/WCAG21-da/#target-size)). 
